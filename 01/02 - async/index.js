...
function brokenRecord() {
    global = setInterval(() => { console.log("Hi") }, 1000)
}

function endCode(e) {
    clearInterval(global);
}
document.addEventListener("keyup", endCode);
// Uncomment the following line to check your work!
brokenRecord();
...
function everyXsecsForYsecs(func, interval, duration) {
    // ADD CODE HERE
    var time = setInterval(func, interval * 1000);
    setTimeout(() => {
        clearInterval(time)
    }, duration * 1000);
